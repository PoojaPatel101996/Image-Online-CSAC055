<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_product.aspx.cs" Inherits="WebApplication9.edit_product" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="main">
             ...
             <br />
            <asp:DropDownList ID="cname" class="un " runat="server" DataSourceID="SqlDataSource1" DataTextField="Category_Name" DataValueField="Category_Name"></asp:DropDownList>
             <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ImageOnlineConnectionString %>" SelectCommand="SELECT [Category_Name] FROM [category]"></asp:SqlDataSource>
            <br />
            <br />
            ...
            <table>
                <tr>
                    <td>
                        <br />
                        &nbsp;<asp:Button ID="edit_prod" runat="server"  Text="Update"  class="submit" align="center" OnClick="edit_prod_Click" />
                    </td>
                    <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="Button2" runat="server"  Text="Cancel"  class="submit1" align="center" OnClick="Button2_Click" />
                    </td>
                </tr>
            </table>
                ...
                <td>
<div id="scroll">
                    <asp:GridView ID="GridView1"  runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" AutoGenerateColumns="False" DataKeyNames="Product_Id" DataSourceID="SqlDataSource2">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:ImageOnlineConnectionString %>" 
                        DeleteCommand="DELETE FROM [product] WHERE [Product_Id] = @original_Product_Id AND [Product_Name] = @original_Product_Name AND [Category_Name] = @original_Category_Name AND [Sales_Price] = @original_Sales_Price AND [Available_quantity] = @original_Available_quantity" 
                        OldValuesParameterFormatString="original_{0}" 
                        SelectCommand="SELECT * FROM [product]" InsertCommand="INSERT INTO [product] ([Product_Id], [Product_Name], [Category_Name], [Sales_Price], [Available_quantity]) VALUES (@Product_Id, @Product_Name, @Category_Name, @Sales_Price, @Available_quantity)" UpdateCommand="UPDATE [product] SET [Product_Name] = @Product_Name, [Category_Name] = @Category_Name, [Sales_Price] = @Sales_Price, [Available_quantity] = @Available_quantity WHERE [Product_Id] = @original_Product_Id AND [Product_Name] = @original_Product_Name AND [Category_Name] = @original_Category_Name AND [Sales_Price] = @original_Sales_Price AND [Available_quantity] = @original_Available_quantity" >
                        <DeleteParameters>
