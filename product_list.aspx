    ...
    <form id="form1" runat="server">
          <table>
               ...
               <Items>
                    ...
                    <td colspan="2"><asp:Button ID="Button1" runat="server" Text="Logout" CssClass="button1" />
                        <asp:Button ID="Button2" runat="server" Text="Add Product" CssClass="button1" PostBackUrl="~/add_product.aspx" />
                    </td>
        ...
        <table id="table1">
            <tr>
                ...
                <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True">
